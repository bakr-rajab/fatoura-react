...
const Home = () => {
  ...
  const calculateSchema = () => {
    ...
    const invoiec = docLines.map((item) => ({
      ...
      quantity: parseFloat(Number(item.invoiceLines__quantity).toFixed(5)),
      internalCode: "" + item.invoiceLines__internalCode,
      salesTotal: parseFloat(Number(item.invoiceLines__salesTotal).toFixed(5)),
      total: parseFloat(Number(item.invoiceLines__total).toFixed(5)),
      valueDifference: parseFloat(Number(item.invoiceLines__valueDifference).toFixed(5)),
      totalTaxableFees: parseFloat(Number(item.invoiceLines__totalTaxableFees).toFixed(5)),
      netTotal: parseFloat(Number(item.invoiceLines__netTotal).toFixed(5)),
      itemsDiscount: parseFloat(Number(item.invoiceLines__itemsDiscount).toFixed(5)),
      unitValue: {
        currencySold: item.invoiceLines__unitValue__currencySold,
        amountEGP: parseFloat(Number(item.invoiceLines__unitValue__amountEGP).toFixed(5)),
      },
      discount: {
        rate: parseFloat(Number(item.invoiceLines__discount__rate).toFixed(5)),
        amount: parseFloat(Number(item.invoiceLines__discount__amount).toFixed(5)),
      },
    ...
    setSchema({
      ...
      extraDiscountAmount: +parseInt(document[0].extraDiscountAmount).toFixed(5),
      totalSalesAmount:+parseInt(document[0].totalSalesAmount).toFixed(5),
      totalItemsDiscountAmount: +parseInt(document[0].totalItemsDiscountAmount).toFixed(5),
      totalDiscountAmount:+parseInt(document[0].totalDiscountAmount).toFixed(5),
      netAmount:+parseInt(document[0].netAmount).toFixed(5),
      totalAmount:+parseInt(document[0].totalAmount).toFixed(5),
      payment: {
        bankName: "",
        bankAddress: "",
        bankAccountNo: "",
      ...
      delivery: {
        ...
        netWeight: +parseInt(document[0].delivery__netWeight).toFixed(5),
